...
-- Function to approve a payment request (admin only)
...
-- Function to reject a payment request (admin only)
...
BEGIN
  ...
  -- If withdraw was already deducted, refund
